...
if st.sidebar.button("🚀 Simular Campaña", type="primary"):
    ...
    if tipo_campana == "Awareness":
        ...
        try:
            modelo_google_data = joblib.load('modelo_impresiones_google.pkl')
            modelo_meta_data = joblib.load('modelo_impresiones_meta.pkl')
    ...
    # ========================================
        ...
        try:
            modelo_clicks_data = joblib.load('modelo_clicks_meta.pkl')
    ...
    # ========================================
        ...
        # Cargar modelos
        try:
            modelo_conv_google_data = joblib.load('modelo_conversiones_google.pkl')
            modelo_conv_meta_data = joblib.load('modelo_conversiones_meta.pkl')
